...
# (num1 / num2). Handle the ZeroDivisionError
...
# Implement a program that takes user input for a filename,
# opens the file in read
# mode, and displays its contents.
# Handle the FileNotFoundError and display an error
...
# Write a Python program that takes a user input and
# converts it to an integer. Handle
...
# Write a Python program that takes two integers as input
# and performs division (num1
...
# InvalidAgeError to handle cases where
# the age is below 0 or above 120.
...
# to handle cases where the password is shorter
# than 8 characters.
